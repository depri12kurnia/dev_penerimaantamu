                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="slug" placeholder="Slug" class="form-control" type="text" hidden>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "lengthChange": true,
            "ajax": {
                "url": "<?php echo site_url('admin/kategori_galeri/ajax_list') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function edit_category(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('admin/kategori_galeri/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_category(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('admin/kategori_galeri/ajax_delete/') ?>" + id,
                type: "POST",
                data: {
    ...
    $('#btnSave').click(function() {
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/kategori_galeri/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('admin/kategori_galeri/ajax_update') ?>";
        }
