    ...
    <div class="col-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Master Data Faq</h3>
                <button class="card-title btn btn-success btn-sm float-right" onclick="add_faq()"><i class="fa fa-plus"></i> Add</a></button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea name="answer" placeholder="Answer" class="form-control" type="text"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "lengthChange": true,
            "ajax": {
                "url": "<?php echo site_url('admin/faq/ajax_list') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function edit_faq(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('admin/faq/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_faq(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('admin/faq/ajax_delete/') ?>" + id,
                type: "POST",
                data: {
    ...
    $('#btnSave').click(function() {
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/faq/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('admin/faq/ajax_update') ?>";
        }
